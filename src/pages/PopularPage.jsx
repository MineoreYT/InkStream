...
const PopularPage = () => {
  ...
  useEffect(() => {
    const fetchPopularManga = async () => {
      try {
        ...
        const data = await mangadexApi.getPopularManga(20, 0, includeNSFW);
  ...
  const loadMore = async () => {
    ...
    try {
      ...
      const data = await mangadexApi.getPopularManga(20, nextPage * 20, includeNSFW);
    ...
    return (
      <div className="flex items-center justify-center min-h-96">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading popular manga...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-96">
        <div className="text-center">
          ...
          <p className="text-red-600 mb-2">Error loading popular manga</p>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <p className="text-gray-600">
          Most followed and loved manga by our community
        </p>
      ...
      {manga.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h2 className="text-xl font-semibold text-gray-700 mb-2">No popular manga found</h2>
          <p className="text-gray-600">
