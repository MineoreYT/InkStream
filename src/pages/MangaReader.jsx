...
const MangaReader = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [chaptersData, pagesData] = await Promise.all([
          ...
          mangadexApi.getChapterPages(chapterId)
        ]);
  ...
  }, [currentPage, pages.length, mangaId]);
      ...
      <div className="min-h-screen bg-gray-900 text-white">
        ...
        <div className="fixed top-0 left-0 right-0 bg-gray-800 p-3 sm:p-4 flex items-center justify-between z-50">
          ...
          >
            ...
            <span className="text-sm sm:text-base">Back to Manga</span>
          </button>
          ...
          <div className="text-center max-w-md">
            ...
            <div className="bg-gray-800 rounded-lg p-6 mb-6 text-left">
              ...
              <ul className="text-sm text-gray-300 space-y-2">
                ...
                <li>• Temporary server issues with MangaDex</li>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-gray-400 mt-4">
                If this problem persists, try checking other chapters or visit MangaDex directly.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="fixed top-0 left-0 right-0 bg-gray-800 p-3 sm:p-4 flex items-center justify-between z-50">
        ...
        <div className="text-center">
          <h1 className="text-sm sm:text-lg font-semibold">
            {currentChapter?.attributes?.title || `Chapter ${currentChapter?.attributes?.chapter}`}
          </h1>
      ...
      {/* Page Content - Responsive size container */}
      <div className="pt-16 sm:pt-20 pb-20 sm:pb-24 min-h-screen flex items-center justify-center overflow-auto">
